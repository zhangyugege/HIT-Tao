...
/**
 * @fileOverview GridFS is a tool for MongoDB to store files to the lib.
 * Because of the restrictions of the object size the lib can hold, a
 ...
 *
 * @class
 * @param {Db} db A lib instance to interact with.
...
/**
 * Opens the file from the lib and initialize this object. Also creates a
...
/**
 * Stores a file from the file system to the GridFS lib.
 *
 * @method
...
/**
 * Saves this file to the lib. This will overwrite the old entry if it
...
/**
 * Deletes all the chunks of this file in the lib.
 *
 * @method
...
/**
 * Deletes all the chunks of this file in the lib if mode was set to "w" or
...
/**
 * Checks if a file exists in the lib.
 *
 * @method
 * @static
 * @param {Db} db the lib to query.
